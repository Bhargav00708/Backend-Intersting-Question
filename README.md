# Back-End Developer Intersting Questions
...
- **Encapsulate State in Objects:** Store the game state (score) within an object like `player`. This keeps the data together and avoids global dependencies.
